            ...
            <div class="sidebar-content">
                ...
                <div class="sidebar-user">
                    <div class="category-content">
                        <div class="media">
                            <a href="#" class="media-left"><img src="assets/images/demo/users/face11.jpg"
                        ...
                        <ul class="navigation navigation-main navigation-accordion">
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="layout_footer_fixed.html">Fixed footer</a></li>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li><a href="http://demo.interface.club/limitless/layout_1/LTR/index.html"
                                           id="layout1">Layout 1</a></li>
                                    <li><a href="index.html" id="layout2">Layout 2 <span class="label bg-warning-400">Current</span></a>
                                    </li>
                                    <li><a href="http://demo.interface.club/limitless/layout_3/LTR/index.html"
                                           id="layout3">Layout 3</a></li>
                                    <li><a href="http://demo.interface.club/limitless/layout_4/LTR/index.html"
                                           id="layout4">Layout 4</a></li>
                                    <li><a href="http://demo.interface.club/limitless/layout_5/LTR/index.html"
                                           id="layout5">Layout 5</a></li>
                                    <li class="disabled"><a
                                                href="http://demo.interface.club/limitless/layout_6/LTR/index.html"
                                                id="layout6">Layout 6 <span
                                                    class="label label-transparent">Coming soon</span></a></li>
                                </ul>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li><a href="starters/layout_navbar_fixed_secondary.html">Fixed secondary navbar</a>
                                    </li>
                            ...
                            <li><a href="changelog.html"><i class="icon-list-unordered"></i> <span>Changelog <span
                                                class="label bg-blue-400">1.6</span></span></a></li>
                            <li><a href="http://demo.interface.club/limitless/layout_1/RTL/default/index.html"><i
                                            class="icon-width"></i> <span>RTL version</span></a></li>
                            <!-- /main -->

                            <!-- Forms -->
                            <li class="navigation-header"><span>Forms</span> <i class="icon-menu" title="Forms"></i>
                            </li>
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="sidebar_dual_double_collapse.html">Dual double collapse</a>
                                            </li>
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="sidebar_detached_sticky_custom.html">Sticky (custom scroll)</a>
                                            </li>
                                            <li><a href="sidebar_detached_sticky_native.html">Sticky (native scroll)</a>
                                            </li>
                            ...
                            <!-- Tables -->
                            <li class="navigation-header"><span>Tables</span> <i class="icon-menu" title="Tables"></i>
                            </li>
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="login_registration_advanced.html">More registration info</a>
                                            </li>
